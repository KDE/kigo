...
#ifndef KGO_OLDGOENGINE_H
#define KGO_OLDGOENGINE_H
...
/**
 * The OldGoEngine class implements the Go game and acts as a wrapper around a
 ...
 *
 * @code
 * OldGoEngine *engine = new OldGoEngine;
 *
 ...
 * @since 0.1
 */
class OldGoEngine : public QObject
{
    Q_OBJECT
...
public:
     ...
     * and 'finalScore' OldGoEngine methods.
     */
    class Score
    {
    public:
    ...
    /**
     * Check whether the OldGoEngine object is connected to a Go engine, running
...
signals:
    ...
    void playerResigned(OldGoEngine::PlayerColor);
    ...
    void currentPlayerChanged(OldGoEngine::PlayerColor);
